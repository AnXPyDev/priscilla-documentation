...
\filedesc{UserEndpoint.php} (\emph{abstract class}) - Endpoint ktorý najskôr vykoná autentikáciu použivateľa, a ak vyhodnotí že je prihlásený, vykoná operáciu. V request body (\emph{JSON}) musí byť poskytnutá hodnota \emph{session}.
...
\filedesc{ClientEndpoint.php} (\emph{abstract class}) - Endpoint ktorý podobne ako \emph{UserEndpoint} overí používaťeľa na základe parametru \emph{secret}.
